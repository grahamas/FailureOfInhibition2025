...
@testset "FailureOfInhibition2025" begin
    ...
    include("test_periodic_continuation.jl")
    include("test_hopf_diagnostics.jl")
    include("test_figure5b_root_lineage.jl")
    include("test_figure5b_axis_continuation.jl")
    include("test_figure5b_curve_seeds.jl")
    include("test_figure5b_curve_traversal.jl")
